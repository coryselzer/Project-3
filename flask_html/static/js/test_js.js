...
function optionChanged() {
    ...
    if (selectedBoroughData) {
        ...
        let metadataItems = [
            `Cyclist Deaths: ${selectedBoroughData.cyclist_deaths}`,
            `Motorist Deaths: ${selectedBoroughData.motorist_deaths}`,
            `Pedestrian Deaths: ${selectedBoroughData.pedestrian_deaths}`,
        ];
    ...
    var pie_data = [{
        values: [selectedBoroughpie.cyclist_death_percentage, selectedBoroughpie.motorist_death_percentage
            , selectedBoroughpie.pedestrian_death_percentage],
